...
static const ItemMeta ITEM_META[] = {
    ...
    {"pistol_9mm",      "9mm 권총",           "weapon_pistol.png",  "표준 반자동 권총. 장탄 9발.",           ItemGrade::Rare,     1},
    {"flamethrower",    "화염방사기",          "weapon_flame.png",   "연료 탱크와 노즐로 구성. 범위 화염 공격.",ItemGrade::Unique,   1},
    {"smg_9mm",         "9mm 기관단총",        "weapon_smg.png",     "9mm 탄환을 빠르게 소모하는 연사 무기.",   ItemGrade::Rare,     1},
    ...
    {"medkit",          "구급 상자",           "item_medkit.png",    "HP 50 회복. 출혈 상태 해제.",           ItemGrade::Rare,     5},
...
static const CraftingRecipe CRAFT_RECIPES[] = {
    ...
    {5,  "smg_9mm",          30, {{"scrap_metal",5},{"electronic_part",2},{"oil",1},{"ammo_9mm",30}}, 4, true, "9mm 기관단총 제작"},
};
